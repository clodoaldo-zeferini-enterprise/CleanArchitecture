        ...
        string result = $@"
            ...
            Navigator AS (
                SELECT
                    ...
                    (total_records / {PageSize}) + (total_records % {PageSize} > 0) AS PageCount
                FROM RecordCount
            )
