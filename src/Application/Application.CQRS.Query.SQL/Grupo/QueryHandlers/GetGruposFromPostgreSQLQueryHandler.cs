...
public class GetGruposFromPostgreSQLQueryHandler : IRequestHandler<GetGruposFromPostgreSQL, GrupoOutResponse>
{
    private readonly IGrupoServiceQuery _grupoServiceQuery;
    private readonly IMediator _mediator;

    public GetGruposFromPostgreSQLQueryHandler(IGrupoServiceQuery grupoServiceQuery, IMediator mediator)
    {
        _grupoServiceQuery = grupoServiceQuery;
        _mediator = mediator;
    }
    public async Task<GrupoOutResponse> Handle(GetGruposFromPostgreSQL request, CancellationToken cancellationToken)
    {
