...
public class GetGruposFromSQLServerQueryHandler : IRequestHandler<GetGruposFromSQLServer, GrupoOutResponse>
{
    private readonly IGrupoServiceQuery _grupoServiceQuery;
    private readonly IMediator _mediator;

    public GetGruposFromSQLServerQueryHandler(IGrupoServiceQuery grupoServiceQuery, IMediator mediator)
    {
        _grupoServiceQuery = grupoServiceQuery;
        _mediator = mediator;
    }

    public async Task<GrupoOutResponse> Handle(GetGruposFromSQLServer request, CancellationToken cancellationToken)
    {
