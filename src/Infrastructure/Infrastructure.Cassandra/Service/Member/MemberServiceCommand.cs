...
namespace Infrastructure.Cassandra.Service.Grupo
{
    public class GrupoServiceCommand : IGrupoServiceCommand
    {
        ...
        public GrupoServiceCommand(ISession session)
        {
        ...
        private async Task<SimpleStatement> CreateCommandSQL (ETypeCpmmand typeCpmmand, Domain.Entities.Grupo member)
        {
        ...
        public async Task<GrupoOutResponse> CreateGrupo(Domain.Entities.Grupo member)
        {
            ...
            _memberOutResponse.SetData(GrupoMapper.FromEntityToDTO(member));
            return _memberOutResponse;   
        }        

        public async Task<GrupoOutResponse> UpdateGrupo(Domain.Entities.Grupo member)
        {
            /*Verifico se o Parâmetro é nulo*/
            if (member == null)
            {
            ...
            var memberCassandra = await GetGrupoById(member.Id);
            ...
            else
            {
                ...
                _memberOutResponse.SetData(GrupoMapper.FromEntityToDTO(member));
                _memberOutResponse.SetResultado(true);
                _memberOutResponse.SetMensagem("Grupo Atualizado com Sucesso!");
        ...
        public async Task<GrupoOutResponse> DeleteGrupo(string id)
        {
            ...
            _memberOutResponse.SetData(GrupoMapper.FromEntityToDTO(member));
            _memberOutResponse.SetResultado(true);
            _memberOutResponse.SetMensagem("Grupo Excluído com Sucesso!");
