...
public sealed class Grupo : Root
{
                 ...
                 , string insertedBy) : base(nomeDoGrupo, insertedBy)
    {
        ...
        var empresa = new Empresa(Id, cnpj, inscricaoEstadual, nomeFantasia, razaoSocial, cpfDoAdministrador, preNomeDoAdministrador, nomeDoMeioDoAdministrador, sobreNomeDoAdministrador, emailDoAdministrador, insertedBy);
...
public sealed class Filial : NetCore.Base.PessoaJuridica
{
    ...
    private void ValidateFilialUpdate()
    {
        NetCore.Base.ValidadorDeRegra
            ...
            .Quando(UpdatedBy == string.Empty.ToString(), "DeletedBy is required")
            .DispararExcecaoSeExistir();
    }
