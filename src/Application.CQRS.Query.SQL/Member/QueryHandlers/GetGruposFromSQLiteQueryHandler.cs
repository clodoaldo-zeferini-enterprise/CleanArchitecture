...
public class GetGruposFromSQLiteQueryHandler : IRequestHandler<GetGruposFromSQLite, GrupoOutResponse>
{
    private readonly IGrupoServiceQuery _grupoServiceQuery;
    private readonly IMediator _mediator;

    public GetGruposFromSQLiteQueryHandler(IGrupoServiceQuery grupoServiceQuery, IMediator mediator)
    {
        _grupoServiceQuery = grupoServiceQuery;
        _mediator = mediator;
    }
    public async Task<GrupoOutResponse> Handle(GetGruposFromSQLite request, CancellationToken cancellationToken)
    {
